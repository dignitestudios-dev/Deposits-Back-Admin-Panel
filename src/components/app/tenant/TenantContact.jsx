...
export default function TenantContact({tenant}) {
  return (
      ...
      <div className="bg-[#F8F8F8] rounded-xl p-6  border border-[#F6F6F6]">
        ...
        <div className="flex flex-col gap-2 mb-4">
          <div className="flex items-center gap-2 bg-white border border-[#E4E4E4] rounded-full px-4 py-2 w-fit">
            ...
            <span className="text-[15px]">{tenant.email}</span>
          </div>
          <div className="flex items-center gap-2 bg-white border border-[#E4E4E4] rounded-full px-4 py-2 w-fit">
            <FiPhone className="text-[#181818]" />
            <span className="text-[15px]">{tenant.phoneNo}</span>
          </div>
        </div>
        <div className="mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[15px]">{tenant.country}</span>
          </div>
        </div>
        <div className="mb-4">
          <p className="font-semibold text-[16px] mb-1">Last four digits of SSN</p>
          <span className="text-[15px]">{tenant.lastFourSSN}</span>
        </div>
        <div className="mb-2">
          <p className="font-semibold text-[16px] mb-1">Government ID</p>
          <div className="flex gap-4">
            <div className="flex flex-col items-center">
              <img src={tenant.governmentIdFront} alt="ID Front" className="w-36 h-20 rounded-md object-cover border" />
              <span className="text-[13px] text-[#7D7D7D] mt-1">Front</span>
            </div>
            <div className="flex flex-col items-center">
              <img src={tenant.governmentIdBack} alt="ID Back" className="w-36 h-20 rounded-md object-cover border" />
      ...
      <div className="bg-white rounded-xl p-6  border border-[#E3DBDB]">
        ...
        <div className="flex items-center justify-between border-b border-[#E3DBDB] pb-4">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-[16px]">{tenant.subscriptionProduct}</span>
            
          </div>
          <span className="font-bold text-[24px] text-[#181818]">${tenant.currentSubPrice||"--"}</span>
        </div>
      </div>
    </div>
  );
