...
const LogOutModal = () => {
  const { logOutModal,setLogOutModal ,hadleLogout } = useApp(AppContext);
  ...
  return (
    logOutModal && (
      <div className="w-screen h-screen flex items-center justify-center bg-[rgba(0,0,0,0.4)] fixed top-0 left-0 right-0 bottom-0 z-30 px-4">
        <div className="bg-[#fff] backdrop-blur-[100px] w-[470px] h-[280px]  rounded-lg ">
          ...
          <p className="text-center text-wrap text-[#565656]" >Are you sure you want to logout?</p>
